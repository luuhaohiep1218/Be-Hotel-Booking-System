...
const cruises = [
  {
    id: 1,
    image:
      "https://storage.googleapis.com/a1aa/image/2hBJSz-SOguJ2-GgVyxCjpl2G4_MVtHZ4BgcdlQS9-4.jpg",
  ...
  },
  {
    id: 2,
    image:
      "https://storage.googleapis.com/a1aa/image/iaTy4_1yAA-QuDCz-GIOsk-EkH3ZOR0ljBIZplQavpo.jpg",
  ...
  },
  {
    id: 3,
    image:
      "https://storage.googleapis.com/a1aa/image/HknWlPSeF46Nq9fX4vhpvuIIChqJAn6YVY-v9hKllm0.jpg",
  ...
  },
  {
    id: 4,
    image:
      "https://storage.googleapis.com/a1aa/image/tTlp2Vbxpj7E9qqY878UEq8tm9T1jjfq_dmQtlrlAvQ.jpg",
    rating: "5.0 (3 đánh giá)",
    location: "Vịnh Hạ Long",
  ...
  },
  {
    id: 5,
    image:
      "https://storage.googleapis.com/a1aa/image/1nx0ByZrww9iidA9IXxuD7-6VPG3MNpiriIpeg47gUY.jpg",
  ...
  },
  {
    id: 6,
    image:
      "https://storage.googleapis.com/a1aa/image/S_LAdYVx2JWLaSUkvW8mOESth0oPBTofHMCQcQ2L0hY.jpg",
...
const hotels = [
  {
    room: "Phòng 1",
    Descriptions: "Phòng 1",
    count: 40,
    image:
      "https://a25hotel.com/files/images/khach-san-tai-ha-noi/khach-san-tai-quan-hai-ba-trung/khach-san-tue-tinh/cao-cap/_Y5A2749-HDR.jpg",
  },
  {
    room: "Phòng 1",
    Descriptions: "Phòng 1",
...
const styles = {
  ...
  backgroundImage: {
    ...
    width: "100%",
    backgroundImage:
      "url('https://i.pinimg.com/736x/9f/65/d1/9f65d15521b34e4abe3810ac7da4f49d.jpg')",
  ...
  roomContainer: {
    textAlign: "center",
    background:
      "url('https://a25hotel.com/files/images/2.jpg') no-repeat center center/cover",
    padding: "50px 0",
    height: "1000px",
  },
            ...
            {hotels.map((hotel, index) => (
              <Col key={index} md={6} sm={6} xs={12}>
                ...
                >
                  ...
                  >{`${hotel.room.toUpperCase()}`}</Card.Title>
                  <Card.Img
                    src={hotel.image}
                    alt={hotel.room}
                    style={{
                  ...
                  >
                    ...
                    >{`${hotel.count} Phòng`}</Card.Text>
                    <Card.Text
                      style={styles.roomDes}
                    >{`Mô tả : ${hotel.Descriptions}`}</Card.Text>
                  </Card.ImgOverlay>
                </Card>
              </Col>
            ))}
