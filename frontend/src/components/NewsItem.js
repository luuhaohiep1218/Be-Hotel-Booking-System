    ...
    <Col md={6} lg={4} className="mb-4">
      ...
      >
        ...
        <Card.Body style={{ display: "flex", flexDirection: "column", flexGrow: 1 }}>
          ...
          <Row className="mb-2" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <Col xs={6}>
              <Card.Text style={{ color: "#ff7700", fontWeight: "bold", textTransform: "uppercase" }}>
                {item.location}
              </Card.Text>
            </Col>
